...
class _SignUpThreeState extends State<SignUpThree> {
  SignUpController signUpController = Get.put(SignUpController(), permanent: false);
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ButtonStyle(
                      ...
                      padding: WidgetStateProperty.all<EdgeInsetsGeometry>(const EdgeInsets.fromLTRB(90, 15, 90, 15)),
                      backgroundColor: WidgetStateProperty.all<Color>(HexColor("#fed8c3")),
                  ...
                  GetBuilder<SignUpController>(builder: (context) {
                    return Text(
                      signUpController.imageFile != null ? signUpController.imageFile!.filename : "No file selected",
                      style: GoogleFonts.poppins(
                        fontSize: 12,
                        color: HexColor("#8d8d8d"),
                      ),
                  ...
                  ElevatedButton(
                    style: ButtonStyle(
                      ...
                      padding: WidgetStateProperty.all<EdgeInsetsGeometry>(const EdgeInsets.fromLTRB(80, 15, 80, 15)),
                      backgroundColor: WidgetStateProperty.all<Color>(HexColor("#fed8c3")),
                      shape: WidgetStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(30),
                      )),
                  ...
                  GetBuilder<SignUpController>(builder: (context) {
                    return Text(
                      signUpController.resumeFile == null ? "No file selected" : signUpController.resumeFile!.filename,
                      style: GoogleFonts.poppins(
                        fontSize: 12,
                        color: HexColor("#8d8d8d"),
                      ),
